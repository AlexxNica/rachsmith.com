...
function createIndexPageHTML(page, allHTML, pages) {
  ...
  fs.readFile('site/content/templates/index/index.html', 'utf8', function(err, indexTemplate) {
    var previousLink = page + 1 == pages ? '' : '<a class="earlier-posts" href="' + (page + 2) + '.html">Earlier Posts</a>';
    var nextLink = page == 0 ? '' : page == 1 ? '<a class="later-posts" href="index.html">Later Posts</a>' :
